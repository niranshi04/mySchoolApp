    ...
    <div class="row shadow bg-white rounded" style="border: 1px solid whitesmoke; padding: 0 40px;">
        <table class="table table-borderless mt-4">
            <form:form class="form-horizontal" action="${submiturl}"
                ...
                <tr>
                    <th style="width: 40%; text-align: center;">Date of Joining ${mandatory}</th>
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">
                        <form:input type="date" path="dateOfJoining" class="form-control" required="true" max="2099-01-01" min="1995-01-01"></form:input>
                        <form:errors path="dateOfJoining" style="color: red;"></form:errors>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th style="width: 40%; text-align: center;">Subject1 ${mandatory}</th>
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">
                        <form:input type="text" path="subject1" class="form-control" required="true"></form:input>
                        <form:errors path="subject1" style="color: red;"></form:errors>
                    </td>
                </tr>
                <tr>
                    <th style="width: 40%; text-align: center;">Subject2 </th>
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">
                        <form:input type="text" path="subject2" class="form-control"></form:input>
                        <form:errors path="subject2" style="color: red;"></form:errors>
                    </td>
                </tr>
                <tr>
                    <th style="width: 40%; text-align: center;"> Subject3</th>
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">
                        <form:input type="text" path="subject3" class="form-control" ></form:input>
                        <form:errors path="subject3" style="color: red;"></form:errors>
                    </td>
                </tr>
                <tr>
                    <th style="width: 40%; text-align: center;">Class Type${mandatory}"
                    Enter one of ("senior","middle","junior")</th>
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">
                        <form:input type="text" path="classType" class="form-control" required="true"></form:input>
                        <form:errors path="classType" style="color: red;"></form:errors>
                    </td>
                </tr>
                <tr>
